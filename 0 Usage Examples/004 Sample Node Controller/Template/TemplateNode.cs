...
using Aki32Utilities.UsageExamples.ResearchArticlesNodeController.Blender;

namespace Aki32Utilities.UsageExamples.ResearchArticlesNodeController.Template
{
    [STNode("/TemplateNode/", "this is template node")]
    public class TemplateNode : STNode
    {
        ...
        [STNodeProperty("Color1", "This is color1", DescriptorType = typeof(Aki32Utilities.UsageExamples.ResearchArticlesNodeController.DescriptorForColor))]
        public Color Color1
        {
            get { return _Color1; }
        ...
        [STNodeProperty("Color2", "This is color2", DescriptorType = typeof(Aki32Utilities.UsageExamples.ResearchArticlesNodeController.DescriptorForColor))]
        public Color Color2
        {
            get { return _Color2; }
